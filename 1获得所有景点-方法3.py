...
parameter = {
    ...
    'zoom':10,
    'city':500000,
    'geoobj':'102.543497|28.384929|112.277384|31.43176',
    'classify_data':'business_area_flag=1;adcode=500101+reserved_keywords=true+sort_rule=0;reserved_keywords=true',
    #'user_loc':'105.652628,29.824731',
    'keywords':'景点'
}
'''
...
while page<6:
    ...
    try:
        ...
        for data in datas:
            print data['id'],data['name'],data['longitude'],data['latitude']
            if not data['id'] in S:
